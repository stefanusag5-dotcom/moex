...
def get_session_phase() -> dict:
    ...
    phases = [
        ...
        (10*60+30, 12*60+30,"morning",   "🟢 Утренняя сессия",   True,  True,  ""),
        (12*60+30, 14*60+30,"midday",    "🟡 Обед (тихо)",       True,  True,  "Объём снижен"),
        (14*60+30, 17*60+30,"afternoon", "🟢 Дневная сессия",    True,  True,  ""),
        (17*60+30, 18*60+45,"closing",   "🟡 Закрытие основной", True,  False, "Закрывай позиции"),
        (18*60+45,19*60,    "between",   "🔴 Пауза",             False, False, "Между сессиями"),
        (19*60,  23*60+50,  "evening",   "🟢 Вечерняя сессия",   True,  True,  ""),
        (23*60+50,24*60,    "eod",       "🔴 Закрытие сессии",   False, False, "Закрывай всё"),
    ]
